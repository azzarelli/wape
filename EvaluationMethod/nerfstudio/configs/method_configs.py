"""
MODIFIED Methods configuration file

    Notes: 
        The following code can be used to run the tuned models, where  %%d can be replaced with the location of the GT data which is defaulted `data/GT`
        ```
...
from nerfstudio.data.datamanagers.gt_datamanager import GTDataManagerConfig

from nerfstudio.engine.optimizers import AdamOptimizerConfig, RAdamOptimizerConfig

from nerfstudio.engine.trainer import TrainerConfig
from nerfstudio.models.nerfacto_custom import NerfactoModelConfig as NMC
from nerfstudio.models.instant_ngp_custom import InstantNGPModelConfig as INGP
from nerfstudio.models.mipnerf_custom import MipNerfModel as MN
from nerfstudio.models.vanilla_nerf_custom import VanillaModelConfig as VMC

from nerfstudio.models.vanilla_nerf import VanillaModelConfig
from nerfstudio.pipelines.gt_pipeline import GTPipelineConfig
...
method_configs["nerfacto"] = TrainerConfig(
    ...
    pipeline=GTPipelineConfig(
        datamanager=GTDataManagerConfig(
            loss_rgb_scale=1.,
            loss_density_scale=1.,
            loss_function_rgb='MSELoss',
            loss_function_density='L1Loss',
            train_batch_size=2048,
            test_batch_size=2048,
            image_batch_size=4096,
        ),
        model=NMC(
        ),
    ),
...
method_configs["mipnerf"] = TrainerConfig(
    ...
    optimizers={
        "fields": {
            "optimizer": RAdamOptimizerConfig(lr=LR, eps=1e-15),
            "scheduler": None,
        }
    },
)
...
method_configs["nerfacto-og"] = TrainerConfig(
    method_name="nerfacto-og",
...
method_configs["instant-ngp-og"] = TrainerConfig(
    method_name="instant-ngp-og",
    steps_per_eval_batch=500,
    steps_per_save=2000,
    max_num_iterations=30000,
    mixed_precision=True,
